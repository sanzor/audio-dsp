...
impl From<crate::domain::service_error::ServiceError> for ServiceError {
    fn from(err: crate::domain::service_error::ServiceError) -> Self {
        match err {
            ...
            crate::domain::service_error::ServiceError::Conflict(msg) => {
                ServiceError::Conflict(msg)
            }
            crate::domain::service_error::ServiceError::Validation(msg) => {
                ServiceError::Internal(msg)
            }
            crate::domain::service_error::ServiceError::Internal(msg) => {
                ServiceError::Internal(msg)
            }
        }
    }
