...
#[openapi(
    ...
    paths(
        ...
        crate::controllers::transforms_controller::create_compile_ticket,
        crate::controllers::transforms_controller::get_compile_ticket_status,
        crate::controllers::transforms_controller::get_compile_resource,
