use domain::{
    db::{WorkspaceId, db_source::SourceId}, sources::{raw_source::RawSource, source_bundle::SourceBundle, source_meta::SourceMeta}, update_source_info_params::UpdateSourceInfoParams,
};
...
pub trait SourcesProvider: Send + Sync {
    ...
    async fn insert_source(&self, source: RawSource, workspace_id: WorkspaceId) -> Result<SourceBundle, String>;
