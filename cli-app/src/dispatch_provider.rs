...
impl DispatchProvider{
    pub fn new()->DispatchProvider{
        DispatchProvider { dispatch_map:Self::create_dispatch_map()}
    }
    ...
    fn populate_dispatchers(hash_map:&mut HashMap<String,DispatcherEnum>){
        ...
        hash_map.insert("delete".to_string(),DispatcherEnum::Delete(DeleteDispatcher{}));
        hash_map.insert("info".to_string(),DispatcherEnum::Info(InfoDispatcher{}));
        hash_map.insert("upload".to_string(),DispatcherEnum::Upload(UploadDispatcher{}));
        hash_map.insert("gain".to_string(),DispatcherEnum::Gain(GainDispatcher{}));
        hash_map.insert("normalize".to_string(),DispatcherEnum::Normalize(NormalizeDispatcher{}));
        hash_map.insert("low_pass".to_string(),DispatcherEnum::LowPass(LowPassDispatcher{}));
        hash_map.insert("high_pass".to_string(),DispatcherEnum::HighPass(HighPassDispatcher{}));
    }
